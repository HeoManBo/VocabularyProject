...
public class word_fragment5 extends Fragment implements View.OnClickListener, TextToSpeech.OnInitListener {
    ViewGroup viewGroup;
    ...
    public void btn_save(){
        ...
        editor.putBoolean("on_off_05", i);
        editor.apply();
    }

    public void btn_load(){
        if(appData != null) {
            i = appData.getBoolean("on_off_05", false);
            if(i == true) {
                star.setBackground(ContextCompat.getDrawable(getActivity(),R.drawable.btn_star_on_normal));
            }
            else{
