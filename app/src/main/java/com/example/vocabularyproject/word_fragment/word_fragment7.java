...
public class word_fragment7 extends Fragment implements View.OnClickListener, TextToSpeech.OnInitListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_word7, container,false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState){
        ...
        star = view.findViewById(R.id.star07);
    ...
    public void onClick(View view) {
        if(view == speak) {
            ...
            if(i == false){
                ...
                sqLiteDatabase.execSQL("insert into word_Table (word,word_class) values (?,?)", new String[]{arr.get(6)[1],arr.get(6)[2]});
            }
            else{
                i = false;
