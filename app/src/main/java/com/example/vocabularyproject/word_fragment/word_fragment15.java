...
public class word_fragment15 extends Fragment implements View.OnClickListener, TextToSpeech.OnInitListener {
    ViewGroup viewGroup;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState){
        ...
        star = view.findViewById(R.id.star15);
        star.setOnClickListener(this);

        Bundle bundle = getArguments(); //ViewPager가 전달한 Bundle 인자 수신
        arr = (ArrayList<String[]>) bundle.getSerializable("word");
        word.setText(arr.get(14)[1]);
        mean.setText(arr.get(14)[2]);
        Example.setText(arr.get(14)[3]);
