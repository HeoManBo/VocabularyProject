...
public class word_fragment8 extends Fragment implements View.OnClickListener, TextToSpeech.OnInitListener {
    ViewGroup viewGroup;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_word8, container,false);
    }
    ...
    public void onClick(View view) {
        if(view == speak) {
            ...
            if(i == false){
                ...
                sqLiteDatabase.execSQL("insert into word_Table (word,word_class) values (?,?)", new String[]{arr.get(7)[1],arr.get(7)[2]});
            }
            else{
                i = false;
