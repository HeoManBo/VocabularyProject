...
public class word_fragment6 extends Fragment implements View.OnClickListener, TextToSpeech.OnInitListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_word6, container,false);
    }
    ...
    public void onClick(View view) {
        if(view == speak) {
            ...
            if(i == false){
                ...
                sqLiteDatabase.execSQL("insert into word_Table (word,word_class) values (?,?)", new String[]{arr.get(4)[1],arr.get(4)[2]});
            }
            else{
                i = false;
