...
public class word_fragment12 extends Fragment implements View.OnClickListener, TextToSpeech.OnInitListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState){
        ...
        star = view.findViewById(R.id.star12);
        ...
        mean.setText(arr.get(11)[2]);
        Example.setText(arr.get(11)[3]);

        //버튼의 상태를 가져오는 함수
        btn_load();
        sentence = view.findViewById(R.id.sentence);
        sentence.setText(arr.get(11)[4]);
    ...
    public void onClick(View view) {
        if(view == speak) {
            ...
            if(i == false){
                ...
                sqLiteDatabase.execSQL("insert into word_Table (word,word_class) values (?,?)", new String[]{arr.get(11)[1],arr.get(11)[2]});
            }
            else{
                i = false;
                ...
                favorityDB.Delete(arr.get(11)[1]);
            }
        }
    }
    @Override
