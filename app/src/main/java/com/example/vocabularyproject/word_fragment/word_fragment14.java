...
public class word_fragment14 extends Fragment implements View.OnClickListener, TextToSpeech.OnInitListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        word.setText(arr.get(13)[1]);
        mean.setText(arr.get(13)[2]);
        Example.setText(arr.get(13)[3]);

        sentence = viewGroup.findViewById(R.id.sentence);
        sentence.setText(arr.get(13)[4]);
    ...
    public void onClick(View view) {
        if(view == speak) {
            ...
            if(i == false){
                ...
                sqLiteDatabase.execSQL("insert into word_Table (word,word_class) values (?,?)", new String[]{arr.get(13)[1],arr.get(13)[2]});
            }
            else{
                i = false;
                btn_delete();
                ...
                favorityDB.Delete(arr.get(13)[1]);
            }
        }
    }
    @Override
    ...
    public void btn_save(){
        ...
        editor.putBoolean("on_off_14", i);
        editor.apply();
    }

    public void btn_load(){
        if(appData != null) {
            i = appData.getBoolean("on_off_14", false);
            if(i == true) {
                star.setBackground(ContextCompat.getDrawable(getActivity(),R.drawable.btn_star_on_normal));
            }
            else{
